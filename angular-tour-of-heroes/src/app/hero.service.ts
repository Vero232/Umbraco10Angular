...
export class HeroService {
    ...
    private path = 'Umbraco/Api/Hero'
   // private path = 'Umbraco/Api/Hero/UpdateHero'
   // private api = environment.baseUrl + 'api/hero';

    private api = `${environment.baseUrl}${this.path}`;


    getHeroesFromApi(): Observable<Hero[]> {
       return this.http.get<Hero[]>(`${this.api}${'/GetAllHeroes'}`)
          .pipe(
